...
class EndpointSlice(pulumi.CustomResource):
    address_type: pulumi.Output[str] = pulumi.property("addressType")
    """
    ...
    endpoints: pulumi.Output[List['outputs.Endpoint']] = pulumi.property("endpoints")
    """
    ...
    ports: pulumi.Output[Optional[List['outputs.EndpointPort']]] = pulumi.property("ports")
    """
