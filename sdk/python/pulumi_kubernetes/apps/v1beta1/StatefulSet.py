...
class StatefulSet(pulumi.CustomResource):
    ...
    spec: pulumi.Output[Optional['outputs.StatefulSetSpec']] = pulumi.property("spec")
    """
    Spec defines the desired identities of pods in this set.
    """

    status: pulumi.Output[Optional['outputs.StatefulSetStatus']] = pulumi.property("status")
    """
