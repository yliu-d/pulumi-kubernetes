...
class CertificateSigningRequest(pulumi.CustomResource):
    ...
    spec: pulumi.Output[Optional['outputs.CertificateSigningRequestSpec']] = pulumi.property("spec")
    """
    The certificate request itself and any additional information.
    """

    status: pulumi.Output[Optional['outputs.CertificateSigningRequestStatus']] = pulumi.property("status")
    """
