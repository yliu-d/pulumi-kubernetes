...
class PodDisruptionBudget(pulumi.CustomResource):
    ...
    spec: pulumi.Output[Optional['outputs.PodDisruptionBudgetSpec']] = pulumi.property("spec")
    """
    Specification of the desired behavior of the PodDisruptionBudget.
    """

    status: pulumi.Output[Optional['outputs.PodDisruptionBudgetStatus']] = pulumi.property("status")
    """
