...
class CustomResourceDefinition(pulumi.CustomResource):
    ...
    spec: pulumi.Output['outputs.CustomResourceDefinitionSpec'] = pulumi.property("spec")
    """
    spec describes how the user wants the resources to appear
    """

    status: pulumi.Output[Optional['outputs.CustomResourceDefinitionStatus']] = pulumi.property("status")
    """
