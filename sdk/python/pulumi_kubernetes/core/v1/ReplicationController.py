...
class ReplicationController(pulumi.CustomResource):
    ...
    spec: pulumi.Output[Optional['outputs.ReplicationControllerSpec']] = pulumi.property("spec")
    """
    Spec defines the specification of the desired behavior of the replication controller. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    """

    status: pulumi.Output[Optional['outputs.ReplicationControllerStatus']] = pulumi.property("status")
    """
