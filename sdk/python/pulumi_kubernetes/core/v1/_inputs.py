...
class ComponentStatusArgs:
    def __init__(__self__, *,
                 ...
                 conditions: Optional[pulumi.Input[List[pulumi.Input['ComponentConditionArgs']]]] = None,
                 kind: Optional[pulumi.Input[str]] = None,
    ...
    @property
    @pulumi.getter
    def conditions(self) -> Optional[pulumi.Input[List[pulumi.Input['ComponentConditionArgs']]]]:
        """
    ...
    @conditions.setter
    def conditions(self, value: Optional[pulumi.Input[List[pulumi.Input['ComponentConditionArgs']]]]):
