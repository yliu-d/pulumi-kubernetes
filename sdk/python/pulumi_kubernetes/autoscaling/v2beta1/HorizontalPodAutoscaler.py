...
class HorizontalPodAutoscaler(pulumi.CustomResource):
    ...
    spec: pulumi.Output[Optional['outputs.HorizontalPodAutoscalerSpec']] = pulumi.property("spec")
    """
    spec is the specification for the behaviour of the autoscaler. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status.
    """

    status: pulumi.Output[Optional['outputs.HorizontalPodAutoscalerStatus']] = pulumi.property("status")
    """
